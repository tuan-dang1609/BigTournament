      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <p className="text-center text-gray-600">
            Cảm ơn bạn đã đăng kí đội cho lớp. Bây giờ bạn có thể chờ đợi lịch thi đấu bằng cách
            theo dõi thông tin trong Discord trường mình nhé
          </p>
              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="flex flex-col">
                  <label className="leading-loose font-semibold text-base-content">
                    Các game mà đội bạn sẽ tham gia
                  </label>
