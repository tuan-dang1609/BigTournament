    ...
    aov: [
      {
        ...
        current: location.pathname === '/tft/ranking/day1',
      },
      {
        name: 'Vòng 2',
        href: '/tft/ranking/day2',
        current: location.pathname === '/tft/ranking/day2',
      },
    ],
  };
      ...
      <div className="mt-40 mx-auto lg:w-[85%] w-[92%] ">
        <div className="flex lg:flex-row flex-col-reverse items-center justify-center">
          <div className="lg:w-[70%] w-full">
            <h2 className="uppercase p-2 text-base-content font-bold lg:text-[40px] text-[30px] lg:text-left text-center">
              Vòng {roundIndex}
            </h2>
        ...
        {lobbyData.map((lobby) => (
          <div key={lobby.lobbyId} className="mb-8">
            <h2 className="text-lg font-bold text-center uppercase py-2 border rounded-ss-lg rounded-se-lg  border-[#48042c]">
              {lobby.lobbyId}
            </h2>
