          ...
          matchData.forEach((match, matchIndex) => {
            ...
            match.info.participants.forEach((participant) => {
              ...
              if (
                totalPoints >= 20 &&
                matchIndex >= 4 &&
                participantMap[puuid].placements[matchIndex] === 1
              ) {
      ...
      <div className="mt-40 mx-auto lg:w-[88%] w-[92%]">
        <div className="flex lg:flex-row flex-col-reverse items-center justify-center">
          <div className="lg:w-[70%] w-full">
            <h2 className="uppercase p-2 text-base-content font-bold lg:text-[30px] text-[30px] lg:text-left text-center">
              {roundIndex}
            </h2>
        ...
        {lobbyData.map((lobby, index) => (
          <div className="table-container mb-10">
            <div className="overflow-x-auto rounded-es-lg rounded-ee-lg shadow-md border border-[#48042c]">
              <table
                key={index}
                className=" table-fixed min-w-full text-base-content lg:w-full md:w-[170%] w-[300%] font-semibold"
              >
                <thead className="bg-[#48042c] text-white ">
                  <tr>
                    <th className="p-2 bg-[#48042c] sticky left-0 z-10 lg:!w-[210px] w-[120px] md:!w-[180px]">
                      Tên Người Chơi
                    </th>
                    <th>Tổng Điểm</th>
