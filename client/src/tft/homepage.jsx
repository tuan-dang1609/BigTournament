...
const CompetitionPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      ...
      <section
        id="participant"
        className="py-10 lg:py-16 px-2 md:px-8 flex lg:flex-row flex-col text-white"
      >
        <div className="xl:w-[68%] lg:w-[70%] w-full  px-2 xl:px-8">
          <div className="font-semibold">
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-y-10 uppercase ">
              ...
              <div className="flex flex-row gap-x-2">
                <div>
                  <img src="/image/prize.png" width={48} height={48} />
                </div>
                <div>
              ...
              <div className="flex flex-row gap-x-2">
                <div>
                  <img src="/image/schedule.png" width={48} height={48} />
                </div>
                <div>
                  <p className="lg:text-[14px] text-[#a7a7a7]">Bắt đầu</p>
                  <p className="lg:text-[14px]">
                    {new Date(league.season.time_start).toLocaleString('en-GB', {
                      weekday: 'short',
                      day: '2-digit',
                      month: 'short',
                      year: 'numeric',
              ...
              <div className="flex flex-row gap-x-2">
                ...
                <div>
                  ...
                  <p className="lg:text-[14px]">
                    {new Date(league.season.time_end).toLocaleString('en-GB', {
                      weekday: 'short',
                      day: '2-digit',
                      month: 'short',
                      year: 'numeric',
          ...
          <section className=" text-white ">
            ...
            <div className="border border-gray-700 rounded-lg p-4 space-y-4 mb-10">
              ...
              <div className="flex flex-row justify-between h-[48px] items-center">
                ...
                <div>
                  <span className="font-bold">{league.league.school_allowed?.join(', ')}</span>
                </div>
              </div>
              <hr className="border-gray-700" />
              <div className="flex flex-row justify-between h-[48px] items-center">
            ...
            <div className="border border-gray-700 rounded-lg p-4 space-y-4 mb-4">
              ...
              <div className="flex flex-row justify-between h-[48px] items-center">
                ...
                <div>
                  <a
                    className="text-[14px] font-bold text-orange-500"
                    href="https://www.facebook.com/dongchuyennghiep"
                  >
                    Dong Chuyen Nghiep
                  </a>
                </div>
              ...
              <div className="flex flex-row justify-between h-[48px] items-center">
                ...
                <div>
                  <a
                    className="text-[14px] font-bold text-orange-500"
                    href="https://discord.gg/crP48bD7"
                  >
                    THPT Phú Nhuận
                  </a>
                </div>
            ...
            <div className="border border-gray-700 rounded-lg p-4 space-y-4 mb-10">
              {league?.prizepool?.slice(0, 4).map((item, index) => (
                <div key={index}>
                  <div
                    className={`flex flex-row justify-between h-[48px] items-center ${
                      index !== 0 ? 'mt-[16px]' : ''
                    }`}
                  >
