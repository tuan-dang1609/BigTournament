        ...
        <div className="max-w-7xl mt-16 mx-auto w-full">
            <div className="max-w-xl px-2 sm:px-6 mx-auto mb-5">
                ...
                <form className="flex flex-col" onSubmit={handleSubmit}>
                    ...
                    <input type="text" onChange={handleChange} defaultValue={currentUser.garenaaccount} id='garenaaccount' placeholder="Acc Liên Quân" className="p-3 my-[6px] rounded-lg border-primary border-[1.5px]" />
