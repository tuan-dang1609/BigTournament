  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-4">Riot Sign-On</h1>
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex flex-col space-y-4">
            {!loggedInUser ? (
              ...
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg flex items-center justify-between">
