...
const PickemChallenge = () => {
  ...
  useEffect(() => {
    const fetchQuestionsAndPredictions = async () => {
      setLoading(true);
      try {
        const questionResponse = await fetch("https://bigtournament-hq9n.onrender.com/api/auth/getquestions", {
          method: "POST",
        ...
        const predictionResponse = await fetch("https://bigtournament-hq9n.onrender.com/api/auth/checkuserprediction", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
