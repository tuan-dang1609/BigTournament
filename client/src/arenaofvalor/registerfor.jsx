...
const TeamRegistrationForm = () => {
    ...
    steps: [
      {
        popover: {
          title: 'Chào mừng',
          description:
            'Chào mừng bạn tới form đăng ký giải đấu Liên Quân giữa các lớp THPT Phú Nhuận. Mình sẽ hướng dẫn chi tiết cách điền nhé.',
        },
      },
      {
        element: '#teamName',
        popover: {
          title: 'Tên đội',
          description:
            'Hãy nhập tên đội của bạn, tối đa là 15 ký tự. Lưu ý là không được đặt tên đội phản cảm, thiếu văn minh nhé.',
        },
      },
      {
        element: '#shortName',
      ...
      },
      {
        ...
        popover: {
          title: 'Lớp',
          description:
            'Hãy nhập lớp bạn đang học. Cú pháp: xAy, trong đó x là 10,11,12 và y là thứ tự lớp trong khối. Lưu ý nếu là 1 lớp có 2 đội trở lên phải báo cho admin.',
        },
      },
      {
        element: '#logoUrl',
        popover: {
          title: 'Logo ID',
          description:
            'Ví dụ bạn có link logo: https://drive.google.com/file/d/1_hPEfE40vu TmbCCVUFsVEwMai-B4je3z/view?usp=drive_link thì chỉ cần ghi 1_hPEfE40vuTmbCCVUFsVEwMai-B4je3z là được. Ảnh nhớ để chế độ Công Khai (Public) và có size 256x256 và clear background.',
        },
      },
      {
        element: '#color',
      ...
      },
      {
        ...
        popover: {
          title: 'Chọn game',
          description:
            'Chọn vào game Liên Quân Mobile. Click vào để thấy thêm phần điền tên trong game',
        },
      },
      {
        element: '#ign',
        popover: { title: 'Nhập IGN', description: 'Điền tên trong game của mỗi thành viên.' },
      },
      {
        element: '#addmember',
        popover: {
          title: 'Thêm thành viên',
          description: 'Bạn có thể add thêm tối đa 2 thành viên.',
        },
      },
      {
        ...
        popover: {
          ...
          description:
            'Bạn có thể xóa nếu như lỡ ấn thêm nhiều thành viên. Lưu ý nút này chỉ xuất hiện khi có 6 hoặc 7 người.',
        },
      },
      {
        element: '#submitTeam',
      ...
      },
      {
        popover: {
          title: 'Kết thúc',
          description:
            'Như vậy là mình đã hướng dẫn các bạn cách điền form rồi nhé. Tụi mình sẽ chỉ giải đáp nếu có 2 đội trở lên trong 1 lớp đăng ký hay có lỗi (Bug) trong quá trình đăng ký. Hạn chót đã được thông báo ở Announcement Discord. Hẹn gặp lại các bạn ở giải đấu nhé!',
        },
      },
    ],
  });
    ...
    const fetchTeams = async () => {
      try {
        const response = await fetch(
          'https://bigtournament-hq9n.onrender.com/api/auth/checkregisterAOV',
          {
            method: 'POST',
            headers: {
  ...
  const handleInputBlur = (game, index) => {
    setTimeout(() => {
      ...
      const isValid = allUsers.some((user) => user.garenaaccount === currentValue);
          ...
          <div className="mx-auto">
            <div>
              <h1 className="text-3xl font-bold text-center">
                Đơn đăng kí giải Arena Of Valor DCN: Season 2
              </h1>
            </div>
            <button
              onClick={startTour}
              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="flex flex-col" id="logoUrl">
                  ...
                  <small className="text-base-content mt-1">
                    ...
                    <Link
                      ...
                      to="https://docs.google.com/document/d/1zlei9yIWtSLfukegTeREZd8iwH2EUT1rTECH4F6Ph64/edit?tab=t.0"
                      target="_blank"
                ...
                <div className="flex flex-col" id="gameChoose">
                  <label className="leading-loose font-semibold text-base-content">
                    Chọn game mà đội bạn sẽ tham gia
                  </label>
                ...
                {formData.games.map((game) => (
                  <div key={game} className="flex flex-col mt-4" id="ign">
                    <label className="leading-loose text-base-content font-bold">
                      Tên trong game {game} của các thành viên
                    </label>
                    <small className="text-base-content mt-1">
                      Mình khuyên phần này các bạn nên đọc{' '}
                      <Link
                        className="text-primary"
                        to="https://docs.google.com/document/d/1zlei9yIWtSLfukegTeREZd8iwH2EUT1rTECH4F6Ph64/edit?tab=t.6823b1wcmvmd"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <strong>lưu ý</strong>
                      ...
                      <div key={index} className="flex items-center space-x-2 mb-2">
                        <div className="relative  focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                          <input
                            ...
                            placeholder={`Nhập tên trong game Liên Quân và chọn từ danh sách`}
                          />
                          ...
                          {suggestions.length > 0 && activeInputIndex === index && (
                            <ul className="absolute z-10 bg-white border border-gray-300 rounded-md mt-1 w-full shadow-lg">
                              {suggestions.map((user) => (
                                <li
                                  key={user.garenaaccount} // Đảm bảo mỗi RiotID là duy nhất
                                  onMouseDown={(e) => e.preventDefault()} // Ngăn mất focus khi click
                                  onClick={() => {
                                    handleMemberChange(game, activeInputIndex, user.garenaaccount); // Gán vào đúng input
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <span className="text-black">({user.garenaaccount})</span>
                                  </div>
                                </li>
                              ))}
                            </ul>
                        ...
                        {(game === 'League Of Legends' ||
                          ...
                          formData.gameMembers[game].length > 5 && (
                            <motion.button
                              id="removemember"
                              type="button"
                        ...
                        {!(
                          ...
                          formData.gameMembers[game].length > 1 && (
                            <motion.button
                              type="button"
                              whileHover={{ scale: 1.1 }}
                              whileTap={{ scale: 0.9 }}
