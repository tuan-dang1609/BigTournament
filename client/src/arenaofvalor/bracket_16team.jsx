...
const TournamentBracketAOV16 = () => {
  ...
  const fetchTeams = async () => {
    try {
      const response = await fetch(
        'https://docs.google.com/spreadsheets/d/1ZGF4cPHRmKL5BSzgAMtUD2WWYrB-Dpx8Q_gFha5T0dY/gviz/tq?sheet=Swiss Stage 2&range=A1:R20'
      );
  ...
  const renderSection = (title, matchups, className = '') => (
    <div
      className={`flex flex-col ${className} border-2 border-gray-300 rounded-lg overflow-hidden`}
    >
      <h2 className="text-lg font-bold p-2 bg-[#D9D9D94D] border-b border-gray-300">{title}</h2>
  ...
  const renderEliminateSection = () => (
    <div className="flex flex-col border-2 border-gray-300 overflow-hidden relative rounded-lg">
      <h2 className="text-lg font-bold p-2 bg-[#D9D9D94D] border-b border-gray-300">Bị loại</h2>
      <div className="p-2">
  ...
  return (
    <div
      className="relative w-[95%] lg:w-full mx-auto "
      id="bracket"
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="max-w-[900px] justify-center flex flex-col mx-auto">
            <p>
              Hiii! Xin chào tất cả các bạn, chào mừng các bạn đã đến với vòng đấu Thụy Sĩ, và đây
              là một số luật lệ tụi mình sẽ có update thêm trong tương lai nhaaaa:{' '}
            </p>
            <ul class="list-disc">
              <li>
                8 đội gồm 2 đội thắng ở nhánh 2-0, 3 đội ở nhánh 2-1 và 3 đội thắng ở nhánh 2-2 sẽ
                đi tiếp.
              </li>
              <li>
                8 đội gồm 2 đội thua ở nhánh 0-2, 3 đội thua ở nhánh 1-2 và 3 đội thua ở nhánh 2-2
                sẽ bị loại.
              </li>
              <li>
                Tất cả các trận ở đây là BO1. Riêng các trận quyết định (2-0, 0-2, 2-1, 1-2, 2-2) sẽ
                là BO3.
              </li>
              ...
              <li>
                Trước giờ thi đấu 12h các bạn phải đưa lại đội hình cho BTC để bọn mình dễ dàng kiểm
          ...
          <div className="w-full overflow-x-scroll scrollbar-none" ref={containerRef}>
            <div className="flex flex-col lg:flex-row justify-between lg:space-x-4 relative w-full lg:w-[140%] mx-auto">
              ...
              <div className="w-full lg:w-1/6 mt-10 lg:mt-20 flex flex-col relative">
                ...
                <div className="lg:mt-80 mt-10">{renderEliminateSection()}</div>
              </div>
            </div>
          </div>
        </>
