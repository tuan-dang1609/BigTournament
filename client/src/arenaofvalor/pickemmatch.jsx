...
const PickemChallengeMatch = () => {
  ...
  const submitPrediction = async () => {
    ...
    const predictionData = matches.map((match, index) => {
      ...
      return {
        questionId: match.questionId, // Include the questionId here
        selectedTeams: selectedTeamsArray,
      };
    });

    try {
      console.log("Submitting prediction...", predictionData); // Log the payload before submission
