...
const PickemChallenge = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState("day6");
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      ...
      try {
        // Fetch teams
        const teamsResponse = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/allteamAOVcolor', {
          method: 'POST',
          headers: {
        ...
        const questionsResponse = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/getquestions', {
          method: 'POST',
        ...
        setLoading(false);
        const scoreResponse = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/comparepredictions', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        ...
        if (currentUser?._id) {
          const predictionsResponse = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/checkuserprediction', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ userId: currentUser._id }),
          });
  ...
  const handleTeamSelect = async (questionId, teamName) => {
    ...
    try {
      const response = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/submitPrediction', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
