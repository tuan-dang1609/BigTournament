...
export default function MatchStatLOL() {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full table-auto text-base-content lg:w-full w-[280%] font-semibold">
          <thead className="bg-[#362431] text-white">
            <tr>
              <th className="p-2 bg-[#362431] sticky left-0 z-10 lg:!w-[270px] !w-[180px]">
                Player
              </th>
                ...
                <tr key={puuid} className="!h-[45.2px]">
                  <td className="lg:!w-[270px] !w-[180px] sticky left-0 bg-base-100 z-10">
                    <div className="flex flex-row gap-x-3">
                      <img
                        src={itemImages[teamPosition]}
                        alt={`${teamPosition}`}
                        className="inline-block h-7 w-7 rounded"
                      />
                      <img
                        src={itemImages[championName]}
                  ...
                  <td className=" text-[13px] p-2   text-center">
                    ...
                    {challenges?.visionScorePerMinute && <span>({challenges.kda.toFixed(1)})</span>}
                  </td>
                  <td className=" text-[13px] p-2   text-center">
                  ...
                  <td className="text-[13px] p-2   text-center">
                    ...
                    {challenges?.visionScorePerMinute && (
                      <span>({challenges.visionScorePerMinute.toFixed(1)})</span>
                    )}
                  </td>
  ...
  const renderSelectedMatch = () => {
    ...
    const sortByTeamPosition = (players) =>
      players.sort(
        (a, b) =>
          teamPositionOrder.indexOf(a.teamPosition) - teamPositionOrder.indexOf(b.teamPosition)
      );
    ...
    return (
      <div key={matchId}>
        {selectedTab === 'table'
          ...
          : renderGoldDifferenceChart(matchId)}
