...
const TeamRegistrationForm = () => {
    ...
    const handleGameToggle = (game) => {
        ...
        if (updatedGames.includes(game)) {
            ...
            updatedGameMembers[game] = (game === "League Of Legends" || game === "Valorant" || game === "Liên Quân Mobile") ? Array(2).fill("") : [""];
        }
            ...
            <div className="relative py-3 lg:max-w-7xl lg:w-5/12 sm:mx-auto">
                <div className="relative px-4 py-8 sm:rounded-3xl sm:px-2 sm:py-12 " >
                    <div className="mx-auto">
                        <div>
                            <h1 className="text-3xl font-bold text-center">Đơn đăng kí giải Valorant Double Up DCN</h1>
                        </div>
                                    ...
                                    <div key={game} className="flex flex-col mt-4" id="ign">
                                        ...
                                        {formData.gameMembers[game].map((member, index) => (
                                            <div key={index} className="flex items-center space-x-2 mb-2">
                                                ...
                                                {(game === "League Of Legends" || game === "Valorant" || game === "Liên Quân Mobile") && formData.gameMembers[game].length > 2 && (
                                                    <motion.button
                                                        id="removemember"
                                                        type="button"
