    ...
    steps: [
      {
        popover: {
          title: 'Chào mừng',
          description:
            'Chào mừng bạn tới form đăng ký giải đấu Valorant Dong Chuyen Nghiep. Mình sẽ hướng dẫn chi tiết cách điền nhé.',
        },
      },
      {
        element: '#teamName',
      ...
      },
      {
        ...
        popover: {
          title: 'Chọn game',
          description: 'Chọn vào game Valorant. Click vào để thấy thêm phần điền tên trong game',
        },
      },
      {
        element: '#ign',
    ...
    const fetchTeams = async () => {
      try {
        const response = await fetch(
          'https://bigtournament-hq9n.onrender.com/api/auth/checkregisterValorant',
          {
            method: 'POST',
            headers: {
          ...
          <div className="mx-auto">
            <div>
              <h1 className="text-3xl font-bold text-center">
                Đơn đăng kí giải Valorant Đón Xuân DCN: Season 2
              </h1>
            </div>
            <button
              onClick={startTour}
