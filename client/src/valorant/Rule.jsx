    ...
    <div className="animate__animated animate__fadeIn max-w-6xl mx-auto p-6 bg-base-100 lg:mt-24 lg:mb-16 mt-[72px] mb-8 rounded-lg text-base-content">
        ...
        content={
          <>
            ...
            <div>
              ...
              một giải đấu Valorant Double Up nhằm tìm ra đội có thành tích xuất sắc nhất cũng như
              giao lưu vui vẻ với nhau sau giữa học kỳ 2.{' '}
            </div>
      ...
      <Section
        ...
        content={
          <>
            ...
            (giờ Việt Nam) hôm diễn ra thi đấu để delay các trận đấu.
          </>
        }
        rules={[
      ...
      <Section
        ...
        content={
          <>
            <li>
              <strong>STAND-IN:</strong> Các bạn chỉ được dùng Stand-in khi đội hình thiếu người thi
              đấu (đã bao gồm dự bị). Luật này chỉ được áp dụng khi Ban Tổ Chức chấp thuận.
            </li>
            <li>
              <strong>THÀNH VIÊN MA:</strong> Các bạn chú ý việc đăng ký đội hình đã được update
              trên website của chúng mình và nếu các bạn đã dùng một người khác đội hình đã đăng kí
              tùy theo trường hợp sẽ xử lý như sau:
            </li>
          </>
        }
        rules={[
      ...
      <Section
        ...
        content={
          <>
            <p>
              Tất cả các trận đấu thuộc khuôn khổ <strong> VALORANT Double Up DCN</strong> sẽ được
              tổ chức theo hình thức online.
            </p>
          </>
        }
      />
      <Section
        ...
        content={
          <>
            <p>
              {' '}
              Các trận sẽ diễn ra từ 19h00 - 22h00. Lịch trình cụ thể sẽ được thông báo trên Discord
            </p>
          </>
        }
      />
      ...
      <Section
        ...
        content={
          <>
            <p>
              Lưu ý: Giải này việc tải app phụ trợ HUD sẽ là không cần thiết. Nếu các bạn muốn tải
              mà sợ bị BAN thì khi làm RSO thì các bạn dùng account không quan trọng nhé.
            </p>
            <ul className="list-disc pl-12">
              <li>
                Link tải app:{' '}
                <a className="text-secondary" href="https://valospectra.com/download">
                  Ấn vào đây để chuyển hướng
                </a>
                .
              </li>
              ...
              <li>
                Khi vào app bên phải thì nó sẽ hiện như ảnh dưới. Lưu ý là BẬT APP TRƯỚC khi vào
                Game nhé. Nếu làm ngược lại thì sẽ không có tác dụng.
              </li>
              <li className="mb-2">
                Khi ở Mục "Auto-detected on game start" hiện riotID mà bạn đang chơi thì coi như là
                thành công rồi nhé"
              </li>
              <img src={Pic2} />
              <li>
                Nếu app này không ảnh hưởng tới hiệu suất của máy trong các thử nghiệm hay không ai
                bị BAN thì trong tương lai, tải App này sẽ là BẮT BUỘC !!!
              </li>
            </ul>
