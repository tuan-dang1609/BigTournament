        ...
        const fetchAllData = async () => {
            try {
                ...
                const matchDetailPromises = matchData.matchid.map(async (id) => {
                    const res = await fetch(`https://bigtournament-hq9n.onrender.com/api/valorant/match/${id}`);
                ...
                const checkPlayerRes = await fetch('https://bigtournament-hq9n.onrender.com/api/auth/check-registered-valorant', {
                    method: 'POST',
                    headers: {
